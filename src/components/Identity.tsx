...
const CARDS: { num: string; title: string; body: ReactNode }[] = [
  ...
  },
  {
    ...
    // ⚠️ "행사 중에는 전부"로 되돌리지 말 것 — 20:48~21:00 네트워킹은
    //    신상 공개가 허용된 구간이다(기획완성본 진행표). 프로그램 구간으로 좁힌다.
    body: "이름, 나이, 학교, 회사, 사는 동네, SNS, 연락처. 프로그램이 진행되는 동안은 전부 비공개입니다. 마지막 네트워킹 시간에 원하시는 분만 밝히면 됩니다. 남는 건 생각뿐입니다.",
  },
  {
    num: "03",
