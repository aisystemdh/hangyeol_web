  ...
  return (
    <form className="form" onSubmit={onSubmit} noValidate>
      ...
      <details className="rules">
        <summary>
          수집 항목과 이용 목적 보기<span className="plus">+</span>
        </summary>
        <div data-answer>
          <p>
            <b>수집 항목</b> — 이름, 연락처, 성별, 나이
            <br />
            <b>이용 목적</b> — 참가 신청 확인, 참가비 입금 안내, 행사 진행 안내
            <br />
            <b>보유 기간</b> — 행사 종료 후 30일 이내 파기
          </p>
          <p>
            동의를 거부하실 수 있으며, 이 경우 신청 접수가 어렵습니다. 행사
            당일에는 실명·나이·직업을 서로 묻지 않으며, 신분증으로 나이를 확인한
            뒤 사본은 보관하지 않습니다.
          </p>
        </div>
      </details>
